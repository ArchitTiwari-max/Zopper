  ...
  return (
    <div className="exec-prof-settings-container">
      <div className="exec-prof-settings-content">
        ...
        {/* Subordinate Visits Card */}
        <div 
          className="exec-prof-godrej-sfdc-card clickable"
          onClick={() => router.push('/executive/subordinate-visits')}
        >
          <div className="exec-prof-card-header-with-action">
            <h2 className="exec-prof-godrej-sfdc-card-title">Subordinate Visits</h2>
          ...
          <div className="exec-prof-card-preview">
            <span className="exec-prof-preview-text">View visits submitted by your subordinates</span>
