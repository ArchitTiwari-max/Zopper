      ...
      <div className="godrej-page-content">
        {isLoading ? (
          ...
          <div className="godrej-error-state">
            ...
            <button onClick={() => window.location.reload()} className="godrej-retry-button">
              Retry
            </button>
          </div>
        ) : data.length === 0 ? (
          <div className="godrej-empty-state">
            ...
            <p>You don't have any Godrej SFDC data synced to your account yet.</p>
          </div>
        ) : (
          <>
            <div className="godrej-search-bar-wrapper">
              <input
                ...
                placeholder="Search by Plan Id, Phone or ContractBookingID"
