  ...
  return (
    <div className="dashboard-overview">
      ...
      <div className="metrics-grid">
        <Link href="/admin/visit-report" className="metric-card clickable">
        ...
        <Link href="/admin/visit-report?visitStatus=PENDING_REVIEW" className="metric-card clickable">
        ...
        <Link href="/admin/issues?status=Pending" className="metric-card clickable">
      ...
      <div className="brand-visits-section">
        ...
        <div className="brand-visits-table">
          ...
          <div className="table-header">
            ...
            <div className="header-cell">TOTAL BRAND VISITS</div>
            <div className="header-cell">UNIQUE STORE VISITS</div>
          </div>
