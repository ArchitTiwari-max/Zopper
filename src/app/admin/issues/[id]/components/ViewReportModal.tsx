...
const ViewReportModal: React.FC<ViewReportModalProps> = ({
  ...
  const fetchReport = async () => {
    ...
    try {
      const response = await fetch(`/api/executive/submit-task?taskId=${assignmentId}`, {
        method: 'GET',
        credentials: 'include',
      });
  ...
  return (
    <div className="view-report-modal-backdrop" onClick={handleBackdropClick}>
      <div className="view-report-modal">
        <div className="modal-header">
          <div className="header-content">
            <h2 className="modal-title">Assignment Report</h2>
