...
const ExecutiveFormContent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchPastVisits = async () => {
      try {
        ...
        const response = await fetch(`/api/admin/visitform?storeId=${storeId}`);
        if (response.ok) {
  ...
  const handleSubmitVisit = async () => {
    ...
    try {
      ...
      const endpoint = isDigital ? '/api/executive/digital-visit' : '/api/admin/visitform';
      ...
      <div className="exec-f-sub-container">
        <div className="exec-f-sub-content">
          <div className="exec-f-sub-error-state">
            ...
            <p>{error}</p>
            <button onClick={() => router.push('/admin/stores')} className="exec-f-sub-back-btn">
              Back to Stores
            </button>
          </div>
        </div>
    ...
    <div className="exec-f-sub-container">
      <div className="exec-f-sub-content">
        ...
        <div className="exec-f-sub-header">
          <button className="exec-f-sub-back-btn" onClick={() => router.push('/admin/stores')}>
